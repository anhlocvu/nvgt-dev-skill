...
- `bool get_system_is_tv() property`
...
- `bool is_power_of_2(const uint16 v)`
- `bool is_power_of_2(const uint32 v)`
- `bool is_power_of_2(const uint64 v)`
- `bool is_power_of_2(const uint8 v)`
...
- `string format_float(double val, const string &in options = \`
- `string format_int(int64 val, const string &in options = \`
- `string format_uint(uint64 val, const string &in options = \`
...
- `uint16 bit_ceil(const uint16 x)`
- `uint16 bit_floor(const uint16 x)`
- `uint16 rotl(uint16 x, int s)`
- `uint16 rotr(uint16 x, int s)`
- `uint32 bit_ceil(const uint32 x)`
- `uint32 bit_floor(const uint32 x)`
- `uint32 rotl(uint32 x, int s)`
- `uint32 rotr(uint32 x, int s)`
- `uint64 bit_ceil(const uint64 x)`
- `uint64 bit_floor(const uint64 x)`
...
- `uint64 rotl(uint64 x, int s)`
- `uint64 rotr(uint64 x, int s)`
- `uint64 secure_ticks()`
- `uint64 ticks(bool secure = false)`
- `uint64[]@ get_touch_devices()`
- `uint8 bit_ceil(const uint8 x)`
- `uint8 bit_floor(const uint8 x)`
- `uint8 character_to_ascii(const string&in character)`
- `uint8 rotl(uint8 x, int s)`
- `uint8 rotr(uint8 x, int s)`
- `uint[]@ get_keyboards()`
- `uint[]@ get_mice()`
...
- `void Scanf(const string &in format, `
...
- `any@ f(?&in)`
- `any@ f(?&in) explicit`
- `any@ f(const double&in)`
- `any@ f(const double&in) explicit`
- `any@ f(const int64&in)`
- `any@ f(const int64&in) explicit`
- `bool f()`
- `int f()`
- `void f()`
- `void f(int&in)`
...
- `int find_by_ref(const T&in if_handle_then_const value) const`
- `int find_by_ref(uint startAt, const T&in if_handle_then_const value) const`
...
- `void f()`
- `void f(int&in)`
- `void f(int&in, const T@+) explicit`
#### Methods
...
- `int find_firstNotOf(const string &in, uint start = 0) const`
- `int find_firstOf(const string &in, uint start = 0) const`
...
- `int find_lastNotOf(const string &in, int start = -1) const`
- `int find_lastOf(const string &in, int start = -1) const`
...
- `string format(`
- `string format(string[]@ elements) const`
- `string lower() const`
